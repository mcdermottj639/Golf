...
const old={...feed,entries:feed.entries.filter(e=>!['round-tm-ballybunion-20260915-review-v1','lesson-sim-approach-repeatability-20260915','round-review-club-map-20260915-v1','round-review-complete-shots-20260915-v2','bay-delivery-20260914-v1'].includes(e.id))};
