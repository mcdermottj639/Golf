...
| 3-wood | **Cobra DS-ADAPT X · 15° stock** | **IN Sep 18 2026.** Golf Galaxy same-day, SKU 26808014, $199. Right hand, Regular, **Project X Denali Blue 60** graphite (Cobra's chart: 64g, mid launch). Takes the fairway-finder slot the mini driver held. **Stock 15.0°, not the 16.5° 3-HL.** FutureFit33 unread. Playing length unmeasured (stock 43.25"). **Live carry still blank.** First look the same day at Golf Lounge 18: TrackMan displayed **150.0**, n=11, cons 58.6 — that average includes two tops (26.4, 34.9). The other nine average **176.5**, peaks 189–201. Jack: *felt amazing*. Parked as a bay offer, not the ladder. Do not park the Sep 14 TrackMan `3w` 182.4 (that was the mini) |
