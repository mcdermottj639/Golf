...
| Irons | Cobra KING TEC **5–PW** | **the 4-iron came out Sep 8 2026** to hold the bag at 14 when the mini went back in, and **stays out Sep 18** now the 3-wood is in — kept with the set, not sold. **44° PW** anchors the wedge ladder. **Sep 18 bay:** 7-iron **131.7 n=11** cons 12.4, best 5 **141.8**. That was the real average — no tops. Path −6.9°, face-to-path **+6.4°**. Sep 14 was 135.9 / 12.5. |
