...
const CACHE = 'caddiehq-v130';  // bump `BUILD` in app.js to match
const ASSETS = ['./', './index.html', './styles.css', './app.js', './lessons.js', './courses-db.js',
  './course-cards.js', './manifest.webmanifest', './icon.svg', './coach-feed.json', './front9-feed.json', './round-review.js', './round-review.css'];
