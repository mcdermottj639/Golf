...
const CACHE = 'caddiehq-v143';  // bump `BUILD` in app.js to match
const ASSETS = ['./', './index.html', './styles.css', './app.js', './lessons.js', './courses-db.js',
  './course-cards.js', './manifest.webmanifest', './icon.svg', './coach-feed.json', './front9-feed.json', './path-feed.json', './round-review.js', './round-review.css'];
